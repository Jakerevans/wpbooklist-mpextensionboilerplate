/**
 * JavaScript Admin Functions - wpbooklist-mpextensionboilerplate-admin.min.js
 *
 * @author   Jake Evans
 * @category JavaScript
...
console.log( wpbooklistMpExtensionBoilerplatePhpVariables );
...
jQuery( document ).ready( function( $ ) {
	...
	wpbooklistMpExtensionBoilerplateAdminPointersJavascript();

	// Function that will handle the saving of the user's License Key.
	wpbooklistMpExtensionBoilerplatePluginPageDashboardSaveKey();

	// Function that will handle the saving of the user's License Key.
	function wpbooklistMpExtensionBoilerplatePluginPageDashboardSaveKey() {

		// When the 'Save' button is clicked at the top of the dashboard...
		$( '#wpbooklist-extension-genreric-key-dashboard-form-mpextensionboilerplate' ).on( 'submit', function() {

			var license = $( '#wpbooklist-extension-genreric-key-dashboard-input-mpextensionboilerplate' ).val();

			// Make Ajax call to get display options.
			var data = {
				'action': 'wpbooklist_mpextensionboilerplate_save_license_key_action',
				'security': wpbooklistMpExtensionBoilerplatePhpVariables.adminnonce1,
				'license': license
			};
		...
		$( '#wpbooklist-extension-genreric-key-plugins-page-button-mpextensionboilerplate' ).on( 'click', function() {
	...
	// Function to display the admin pointer message when entering the Question Mark image with mouse...
	function wpbooklistMpExtensionBoilerplateAdminPointersJavascript() {
