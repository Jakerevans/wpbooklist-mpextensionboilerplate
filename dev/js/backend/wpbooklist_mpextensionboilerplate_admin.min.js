...
jQuery( document ).ready( function( $ ) {
	...
	function wpbooklistMpExtensionBoilerplatePluginPageDashboardSaveKey() {
		...
		$( '#wpbooklist-extension-licence-key-dashboard-form-mpextensionboilerplate' ).on( 'submit', function() {
		...
		$( '#wpbooklist-extension-licence-key-plugins-page-button-mpextensionboilerplate' ).on( 'click', function() {
