<?php
/**
 * WPBookList WPBookList_Kindle_Update_Actual Class
 *
 * @author   Jake Evans
 * @category admin
...
if ( ! class_exists( 'WPBookList_Kindle_Update_Actual', false ) ) :
	/**
	 * WPBookList_Kindle_Update_Actual Class.
	 */
	class WPBookList_Kindle_Update_Actual {
		...
		public function __construct( $_api_url, $_plugin_file, $_api_data = null ) {
			...
			if ( $test_name === $wpdb->get_var( "SHOW TABLES LIKE '$test_name'" ) ) {
				...
				if ( false === stripos( $this->extension_settings->ovbj, 'aod' ) ) {
					error_log('no dice!');
					return false;
				}
				 ...
				 */
				do_action( 'post_edd_sl_plugin_updater_kindle_setup', $edd_plugin_data );
